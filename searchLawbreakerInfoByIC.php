...
$sql = "select distinct lawbreakerInfo_tb.carId, lawbreakerInfo_tb.carOwnerId, carOwner_tb.carOwnerName, carOwner_tb.carOwnerSex, carOwner_tb.carOwnerPhoneNumber, car_tb.carName, car_tb.carColor from car_tb, carOwner_tb, lawbreakerInfo_tb where lawbreakerInfo_tb.carId = car_tb.carId and lawbreakerInfo_tb.carOwnerId = carOwner_tb.carOwnerId and carOwner_tb.carOwnerId = '{$carOwnerId}'";
